...
output. The fix is versioned as 0.2.0. Once that version is available from
crates.io, upgrade explicitly:
...
result, and set only trusted variables manually. Yanking 0.1.0 does not remove
an installed binary or update an existing lockfile.
